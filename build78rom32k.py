"""
Atari 7800 32K ROM Builder

This module generates C source code to emulate a 32K Atari 7800 ROM cartridge
on a Raspberry Pi Pico. It strips the 128-byte A78 header and creates the
emulation code for the ROM data.

32K is a larger size for Atari 7800 games without bankswitching.
...
class rom:
    """
    32K ROM builder class for Atari 7800 cartridges.
    
    This class reads a 32KB A78 ROM file, strips the 128-byte header,
